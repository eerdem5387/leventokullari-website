...
import { Users, Eye, Mail, Calendar, Search, Copy, Check } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Müşteri Yönetimi</h1>
          <p className="text-gray-500 mt-1">Toplam {filteredCustomers.length} kayıtlı müşteri</p>
        </div>
      </div>
          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                ...
                <th className="px-6 py-4 font-semibold text-gray-600 text-center">Siparişler</th>
                <th className="px-6 py-4 font-semibold text-gray-600 text-right">Toplam Harcama</th>
                <th className="px-6 py-4 font-semibold text-gray-600 text-right">Kayıt Tarihi</th>
              ...
              {filteredCustomers.length > 0 ? (
                filteredCustomers.map((customer) => (
                  <tr key={customer.id} className="hover:bg-blue-50/30 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                        <div className="flex items-center gap-2 group/email cursor-pointer" onClick={() => copyToClipboard(customer.email)}>
